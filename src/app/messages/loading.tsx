      ...
      <div className="flex h-full w-full min-w-0 flex-1 flex-col">
        <div className="sketch-grid flex flex-1 flex-col overflow-y-auto bg-[#fdfaf2] pt-6 pb-28 md:pb-8">
          ...
          <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 pb-5 md:flex-row md:items-center md:justify-between md:px-8">
            <div>
              <h1 className="relative text-2xl font-bold tracking-[-0.04em] md:text-3xl">
                Messages
                <span className="ml-2 inline-block h-5 w-16 animate-pulse rounded-full border-2 border-[#1f1c14]/20 bg-[#ece9de] align-middle" />
              </h1>
              <svg
                viewBox="0 0 300 16"
                ...
                aria-hidden="true"
                focusable="false"
                className="mt-1 h-3 w-44 md:w-56"
              >
                <path
          ...
          <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-2 pt-6 pb-4 sm:grid-cols-2 lg:grid-cols-3">
            {[...Array(6)].map((_, i) => (
              ...
              >
                ...
                <div className="mb-1 h-4 animate-pulse rounded bg-[#ece9de]" style={{ width: "62%" }} />
                <div className="mt-2 h-2.5 animate-pulse rounded bg-[#ece9de]/70" style={{ width: "92%" }} />
                <div className="mt-1.5 h-2.5 animate-pulse rounded bg-[#ece9de]/70" style={{ width: "78%" }} />
                <div className="mt-1.5 h-2.5 animate-pulse rounded bg-[#ece9de]/70" style={{ width: "85%" }} />
                <div className="mt-3 h-2 w-12 animate-pulse rounded bg-[#ece9de]/70" style={{ marginLeft: "auto" }} />
              </div>
            ))}
          </div>
        </div>
