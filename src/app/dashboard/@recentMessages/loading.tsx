const Loading = () => {
  return (
    <section className="flex min-h-72 flex-col rounded-xl border-2 border-[#e5e5e5] bg-white p-3.5">
      ...
      {[...Array(4)].map((_, i) => (
        <div
          key={i}
          className="flex items-center gap-3 border-b-2 border-dashed border-[#f5f5f5] py-2.5 last:border-b-0"
        >
